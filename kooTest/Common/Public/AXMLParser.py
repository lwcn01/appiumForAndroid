...
class AXMLParser:
    def __init__(self, data):
        ...
        self.CHUNK_XML_TEXT = 0x00100104
    ...
    def getAttributeCount(self):
        return int(len(self.m_attributes)/self.ATTRIBUTE_LENGHT)
...
class APK:
    ...
    def versionCode(self):
         # versionCode value值为空，待解决
        return self.content['versionCode']

    def versionName(self):
        return self.content['versionName']

#with open("C:\\Users\\Administrator\\Desktop\\AndroidManifest.xml",'rb') as f:
#    a = APK(f.read())
#print(a.packageName(),a.versionCode(),a.versionName())